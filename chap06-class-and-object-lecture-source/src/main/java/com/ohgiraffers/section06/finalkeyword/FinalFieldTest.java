...
//    private final int nonStaticNum;      // 0으로 초기화되어 이후 변경 불가능하기 때문에 에러발생
...
//    private final int STATIC_NUM;       // 0으로 초기화 되어 이후 변경 불가능하기 때문에 에러발생.
...
//        FinalFieldTest.STATIC_DOUBLE = static_double;
//    }
