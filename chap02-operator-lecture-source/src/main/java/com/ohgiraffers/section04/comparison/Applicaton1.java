...
public class Applicaton1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 문자값 비교 */
        char ch1 = 'a';     //'a' = ASCII code (DEC) 97
        char ch2 = 'A';     //'A' = ASCII code (DEC) 65
        ...
        System.out.println("isTrue1과 isTrue2가 같은지 비교 : " + (isTrue1 == isTrue2));
        System.out.println("isTrue1과 isTrue2가 다른지 비교 : " + (isTrue1 != isTrue2));
//        System.out.println("isTrue1이 isTrue2보다 큰지 비교 : " + (isTrue1 > isTrue2));
