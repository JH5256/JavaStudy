...
public class Application1 {
    public static void main(String[] args) {
        ...
        *   1-1. &&(논리 AND) 연산자 : 두 개의 논리식중 모두 참 일 경우 참을 반환, 하나라도 거짓인 경우 거짓을 반환.
        *   1-2. ||(논리 OR) 연산자 : 두 개의 논리식중 하나라도 참 일 경우 참을 반환, 둘 다 거짓일 경우 거짓을 반환.
        *
        *  2. 논리 부정 연산자 : 피연산자가 하나인 단항 연산자
        *   2-1. !(논리 NOT) 연산자 : 논리식의 결과가 참이면 거짓을 반환, 거짓일 경우 참을 반환.
        * */
        ...
        System.out.println("false의 NOT 연산 : " + (!false));            //false
