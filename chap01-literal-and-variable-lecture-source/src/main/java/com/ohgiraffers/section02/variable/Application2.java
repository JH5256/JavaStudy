...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        *   이러한 자료형은 기본자료형(Primary type)과 참고자료형(Reference type)으로 나누어진다.
        *   그 중 기본자료형 8가지 부터 살펴보자.*/
        ...
        /* 문자열을 취급하는 자료형 (기본 자료형은 아니다.) */
        String str;     // 4byte

        bnum = 1;
        snum = 2;
        inum = 4;
//        lnum = 8;     // 아무 문제 없을 것 같지만 Long에서는 대문자 L을 붙여야 한다.
        lnum = 8L;

//        fnum = 4.0;   //java는 기본적으로 실수는 double로 인식하기 때문에 float를 쓰려면 소문자 f를 붙여야 한다.
        fnum = 4.0f;
        dnum = 8.0;
        ...
        *   정수형은 int, 실수형은 double이 대표 자료형이다.*/
        ...
        System.out.println("String의 값: " + str);
