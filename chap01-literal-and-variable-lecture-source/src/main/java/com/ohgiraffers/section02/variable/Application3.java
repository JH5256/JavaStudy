...
public class Application3 {
    public static void main(String[] args) {
        ...
        *    1-2. 예약어는 사용이 불가능하다. (자바에서 미리 사용하겠다고 Complier와 약속한 키워드들을 예약어라고 한다.)
        ...
        *    2-1. 변수명의 길이 제한은 없다. (적당히 할 것.)
        *    2-2. 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두 번째 시작 언어는 대문자로 시작한다.(camel-case)
...
//        int sh^rp = 20;   //사용 가능한 특수문자 외에는 사용 불가.

        int aaaaaaaaaaaaaaaaaaaaaaaaa;

        int maxAge = 20;     //camel-case(카멜 케이스) 방식
        int minAge = 10;
        ...
        int 나이;             //가능하지만 권장하지는 않음.

        String s;            //변수가 어떤 의미인지 파악하기 힘들다.
        String name;         //문자열 형태의 이름이 저장되겠구나 하는 의도 파악 可
