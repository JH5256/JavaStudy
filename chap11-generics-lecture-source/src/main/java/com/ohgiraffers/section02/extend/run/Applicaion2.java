...
//        wildCardFarm.anyType(new RabbitFarm<Reptile>(new Reptile()));
        ...
        /* <? extends Bunny > */
//        wildCardFarm.extensType(new RabbitFarm<Rabbit>(new Rabbit()));
        wildCardFarm.extensType(new RabbitFarm<Bunny>(new Bunny()));
        wildCardFarm.extensType(new RabbitFarm<DrunkenBunny>(new DrunkenBunny()));
