...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("substring(3, 6) : " + javamysql.substring(3, 6));       //amy (3, 4, 5까지)
        System.out.println("substring(3) : " + javamysql.substring(3));    //amysql (시작 인덱스 ->)
       ...
       * */
        ...
        System.out.println("빈 문자열의 길이 : " + (" ".length()));    //1
